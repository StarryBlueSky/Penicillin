...
import jp.nephy.penicillin.endpoint.parameter.SearchResultType
...
class Search(override val client: PenicillinClient): Endpoint {
    ...
    @PrivateEndpoint
    fun typeahead(q: String? = null, vararg options: Pair<String, Any?>)= client.session.getObject<SearchTypeahead>("/search/typeahead.json") {
