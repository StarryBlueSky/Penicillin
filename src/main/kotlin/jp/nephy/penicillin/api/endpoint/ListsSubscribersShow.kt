...
class ListsSubscribersShow(oauth: OAuthRequestHandler) : AbsOAuthGet<UserModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/lists/subscribers/show.json"
