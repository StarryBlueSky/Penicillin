...
//list
class StatusesMentionsTimeline(oauth: OAuthRequestHandler) : AbsOAuthGet<TweetModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/statuses/mentions_timeline.json"
