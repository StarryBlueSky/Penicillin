...
class DirectMessagesShowModel(val json: JsonElement) {
...
class DirectMessagesShow(oauth: OAuthRequestHandler) : AbsOAuthGet<DirectMessagesShowModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/direct_messages/show.json"
