...
class ListsShowModel(val json: JsonElement) {
...
class ListsShow(oauth: OAuthRequestHandler) : AbsOAuthGet<ListsShowModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/lists/show.json"
