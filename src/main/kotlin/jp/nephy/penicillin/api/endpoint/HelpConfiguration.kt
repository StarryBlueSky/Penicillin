...
class HelpConfigurationModel(val json: JsonElement) {
...
class HelpConfiguration(oauth: OAuthRequestHandler): AbsOAuthGet<HelpConfigurationModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/help/configuration.json"
