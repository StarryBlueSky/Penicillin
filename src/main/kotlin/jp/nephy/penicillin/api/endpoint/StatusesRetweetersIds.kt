...
class StatusesRetweetersIdsModel(val json: JsonElement) {
    val ids by json.byNullableArray // [933178201]
...
class StatusesRetweetersIds(oauth: OAuthRequestHandler) : AbsOAuthGet<StatusesRetweetersIdsModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/statuses/retweeters/ids.json"
