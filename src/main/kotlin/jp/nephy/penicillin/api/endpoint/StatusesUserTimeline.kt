...
//list
class StatusesUserTimeline(oauth: OAuthRequestHandler) : AbsOAuthGet<TweetModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/statuses/user_timeline.json"
