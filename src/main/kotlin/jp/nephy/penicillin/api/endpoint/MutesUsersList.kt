...
class MutesUsersListModel(val json: JsonElement) {
...
class MutesUsersList(oauth: OAuthRequestHandler) : AbsOAuthGet<MutesUsersListModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/mutes/users/list.json"
