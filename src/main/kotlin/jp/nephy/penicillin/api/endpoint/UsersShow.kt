...
class UsersShowModel(val json: JsonElement) {
}

class UsersShow(oauth: OAuthRequestHandler) : AbsOAuthGet<UserModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/users/show.json"
