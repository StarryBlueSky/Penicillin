...
class SavedSearchesShowModel(val json: JsonElement) {
...
class SavedSearchesShow(oauth: OAuthRequestHandler) : AbsOAuthGet<SavedSearchesShowModel>(oauth) {
    override val resourceUrl = "https://api.twitter.com/1.1/saved_searches/show.json"
