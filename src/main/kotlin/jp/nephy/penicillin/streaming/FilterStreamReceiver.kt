...
class FilterStreamReceiver(response: ResponseStream<IFilterStreamListener>, private val listener: IFilterStreamListener): AbsStreamingParser<IFilterStreamListener>(response) {
