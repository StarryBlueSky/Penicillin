...
import jp.nephy.penicillin.endpoints.parameter.ListCreationMode
...
class Lists(override val client: PenicillinClient): Endpoint {
    ...
    fun list(userId: Long? = null, screenName: String? = null, reverse: Boolean? = null, vararg options: Pair<String, Any?>)= client.session.getList<TwitterList>("/lists/list.json") {
