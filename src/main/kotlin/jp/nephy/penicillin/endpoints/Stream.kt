...
class Stream(override val client: PenicillinClient): Endpoint {
    ...
    fun sample(delimited: String? = null, stallWarnings: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/statuses/sample.json", EndpointHost.Stream) {
