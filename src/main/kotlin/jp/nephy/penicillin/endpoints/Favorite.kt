...
class Favorite(override val client: PenicillinClient): Endpoint {
    fun list(userId: Long? = null, screenName: String? = null, sinceId: Long? = null, maxId: Long? = null, count: Int? = null, includeEntities: Boolean? = null, vararg options: Pair<String, Any?>) =
