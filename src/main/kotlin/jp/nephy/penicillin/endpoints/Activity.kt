...
class Activity(override val client: PenicillinClient): Endpoint {
    @PrivateEndpoint
    fun activityAboutMe(sinceId: Long? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/activity/about_me.json") {
    ...
    @PrivateEndpoint
    fun activityAboutMeUnread(vararg options: Pair<String, Any?>) = client.session.get("/1.1/activity/about_me/unread.json") {
