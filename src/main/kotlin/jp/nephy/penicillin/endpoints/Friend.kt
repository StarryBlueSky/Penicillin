...
class Friend(override val client: PenicillinClient): Endpoint {
    ...
    fun list(userId: Long? = null, screenName: String? = null, count: Int? = null, skipStatus: Boolean? = null, includeUserEntities: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/friends/list.json") {
