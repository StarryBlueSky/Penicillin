...
class Status(override val client: PenicillinClient): Endpoint {
    fun show(id: Long, trimUser: Boolean? = null, includeMyRetweet: Boolean? = null, includeEntities: Boolean? = null, includeExtAltText: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/statuses/show.json") {
    ...
    fun lookup(id: kotlin.collections.List<Long>, trimUser: Boolean? = null, map: Boolean? = null, includeEntities: Boolean? = null, includeExtAltText: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/statuses/lookup.json") {
    ...
    fun retweetsOfMe(count: Int? = null, sinceId: Long? = null, maxId: Long? = null, trimUser: Boolean? = null, includeEntities: Boolean? = null, includeUserEntities: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/1.1/statuses/retweets_of_me.json") {
    ...
    fun embedFormat(url: String, maxwidth: Int? = null, hideMedia: Boolean? = null, hideThread: Boolean? = null, omitScript: Boolean? = null, align: EmbedAlign? = null, related: kotlin.collections.List<String>? = null, lang: String? = null, theme: String? = null, linkColor: String? = null, widgetType: EmbedWidgetType? = null, dnt: Boolean? = null, vararg options: Pair<String, Any?>) = client.session.get("/oembed", EndpointHost.Publish) {
        authType(AuthorizationType.None)
        parameter("url" to url, "maxwidth" to maxwidth, "hide_media" to hideMedia, "hide_thread" to hideThread, "omit_script" to omitScript, "align" to align?.value, "related" to related?.joinToString(","), "lang" to lang, "theme" to theme, "link_color" to linkColor, "widget_type" to widgetType?.value, "dnt" to dnt, *options)
    }.jsonObject<Embed>()
